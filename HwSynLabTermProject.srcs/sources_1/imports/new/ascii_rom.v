...
module ascii_rom(
	...
	always @*
		case(addr_reg)
			...
			11'h614: data = 8'b01111100;	//
			11'h615: data = 8'b01111110;	//
			11'h616: data = 8'b00000110;	//
			11'h617: data = 8'b01111110;	//
			11'h618: data = 8'b11111110;	//
			11'h619: data = 8'b11000110;	//
			11'h61a: data = 8'b11111110;	//
			11'h61b: data = 8'b01111100;	//
			...
			11'h625: data = 8'b11000000;	//
			11'h626: data = 8'b11111100;	//
			11'h627: data = 8'b11111110;	//
			...
			11'h634: data = 8'b00111110;	//
			11'h635: data = 8'b01111110;	//
			11'h636: data = 8'b11100000;	//
			11'h637: data = 8'b11000000;	//
			11'h638: data = 8'b11000000;	//
			11'h639: data = 8'b11100000;	//
			11'h63a: data = 8'b01111110;	//
			11'h63b: data = 8'b00111110;	//
			...
			11'h663: data = 8'b01111110;	//
			11'h664: data = 8'b01100110;	//
			11'h665: data = 8'b01100000;	//
			11'h666: data = 8'b11111000;	//
			11'h667: data = 8'b11111000;	//
			...
			11'h675: data = 8'b01111000;	//
			11'h676: data = 8'b11111100;	//
			...
			11'h686: data = 8'b11111000;	//
			11'h687: data = 8'b11111110;	//
			11'h688: data = 8'b11001110;	//
			...
			11'h6ac: data = 8'b10000110;	//
			11'h6ad: data = 8'b11001110;	//
			11'h6ae: data = 8'b11111110;	//
			11'h6af: data = 8'b01111100;	//
			// code x6b (k)
			...
			11'h6b5: data = 8'b01100000;	//
			11'h6b6: data = 8'b01101100;	//
			11'h6b7: data = 8'b01101100;	//
			11'h6b8: data = 8'b01110000;	//
			11'h6b9: data = 8'b01111100;	//
			11'h6ba: data = 8'b01101100;	//
			11'h6bb: data = 8'b01101100;	//
			...
			11'h6ca: data = 8'b01100000;	//
			11'h6cb: data = 8'b01110000;	//
			...
			11'h6e5: data = 8'b01111100;	//
			11'h6e6: data = 8'b11111110;	//
			...
			11'h6f4: data = 8'b00111000;	//
			11'h6f5: data = 8'b01111100;	//
			11'h6f6: data = 8'b11101110;	//
			11'h6f7: data = 8'b11000110;	//
			11'h6f8: data = 8'b11000110;	//
			11'h6f9: data = 8'b11101110;	//
			11'h6fa: data = 8'b01111100;	//
			...
			11'h726: data = 8'b11111110;	//
			11'h727: data = 8'b11100110;	//
			...
			11'h734: data = 8'b00111100;	//
			11'h735: data = 8'b01111100;	//
			11'h736: data = 8'b01100000;	//
			11'h737: data = 8'b01111100;	//
			11'h738: data = 8'b00111110;	//
			11'h739: data = 8'b00000110;	//
			11'h73a: data = 8'b00111110;	//
			...
			11'h752: data = 8'b00011000;	//
			11'h753: data = 8'b00011000;	//
			11'h754: data = 8'b01111110;	//
			11'h755: data = 8'b01111110;	//
			11'h756: data = 8'b00011000;	//
			11'h757: data = 8'b00011000;	//
			11'h758: data = 8'b00011000;	//
			11'h759: data = 8'b00011000;	//
			11'h75a: data = 8'b00011100;	//
			11'h75b: data = 8'b00011100;	//
			...
			11'h765: data = 8'b11001100;	//
			11'h766: data = 8'b11001100;	//
			11'h767: data = 8'b11001100;	//
			11'h768: data = 8'b11001100;	//
			11'h769: data = 8'b11001100;	//
			11'h76a: data = 8'b01111000;	//
			11'h76b: data = 8'b00110000;	//
			...
			11'h777: data = 8'b01000100;	//
			11'h778: data = 8'b11000110;	//
			11'h779: data = 8'b11010110;	//
			11'h77a: data = 8'b11010110;	//
			11'h77b: data = 8'b01111100;	//
			...
			11'h786: data = 8'b11101110;	//
			11'h787: data = 8'b01101100;	//
			11'h788: data = 8'b00111000;	//
			11'h789: data = 8'b01101100;	//
			11'h78a: data = 8'b11101110;	//
			...
			11'h797: data = 8'b01100110;	//
			11'h798: data = 8'b01100110;	//
			11'h799: data = 8'b01100110;	//
			11'h79a: data = 8'b01111110;	//
			11'h79b: data = 8'b00111110;	//
			11'h79c: data = 8'b00000110;	//
			11'h79d: data = 8'b01100110;	//
			11'h79e: data = 8'b01111110;	//
			11'h79f: data = 8'b00111100;	//
			// code x7a (z)
			...
			11'h7a6: data = 8'b00001110;	//
			11'h7a7: data = 8'b00011100;	//
			11'h7a8: data = 8'b00111000;	//
			11'h7a9: data = 8'b01110000;	//
